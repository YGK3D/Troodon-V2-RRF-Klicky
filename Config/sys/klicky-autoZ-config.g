...
set global.clickypinname = "probe" ; < edit leaving quotes


; THIS IS THE NAME OF THE PIN YOUR Z PIN IS CONNECTED TO
set global.zpinname = "zstop" ; < edit leaving quotes
...
set global.clickyoffset = 2.95 ; larger values here means nozzle closer to the bed after autoz
